...
Generate a JSON configuration for 4 to 6 meaningful dashboard charts that would give the best insights into this data.
        Valid chart types: 'bar', 'line', 'area', 'pie', 'scatter', 'radar', 'treemap', 'heatmap_matrix', 'step_line', 'funnel'.
        Choose 'heatmap_matrix' for comparing two categories by a numeric metric.
        Choose 'step_line' for non-continuous interval changes.
        Choose 'treemap' for hierarchical or part-to-whole categorical data.
        Return ONLY valid JSON according to this structure:

Each object must follow this structure:
{{
    "id": "unique_string_id",
    "title": "Descriptive Title (e.g. 'Revenue by Region')",
    "type": "bar" | "line" | "scatter" | "pie" | "area" | "radar" | "treemap" | "heatmap_matrix" | "step_line" | "funnel",
